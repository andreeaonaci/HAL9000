...
)
{
    ...
    LockAcquire(&m_threadSystemData.AllThreadNoLock, &oldStatus);

    DWORD theNo = m_threadSystemData.AllThreadNo;

    LockRelease(&m_threadSystemData.AllThreadNoLock, oldStatus);
